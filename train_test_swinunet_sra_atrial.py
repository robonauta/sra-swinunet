...
from datasets import SwinUNetNiiDataset
...
def main():
    ...
    MODEL_NAME = f"swinunet_{args.exp}_atrial"
    ...
    mean = [170.59402267848]
    std = [260.43654392501156]
    ...
    if TRAIN_SIZE > 0:
        train_ds = SwinUNetNiiDataset(
            "datasets/atrial/annotations/training/",
            "datasets/atrial/images/training/",
            transforms,
            target_transforms,
            seed=13,
    ...
    val_ds = SwinUNetNiiDataset(
        "datasets/atrial/annotations/validation/",
        "datasets/atrial/images/validation/",
        transforms,
        target_transforms,
        seed=13,
        train_size=DATASET_PERC,
    )
    test_ds = SwinUNetNiiDataset(
        "datasets/atrial/annotations/testing/",
        "datasets/atrial/images/testing/",
        transforms,
        target_transforms,
        seed=13,
        train_size=DATASET_PERC,
