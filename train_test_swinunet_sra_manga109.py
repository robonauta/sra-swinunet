...
def main():
    ...
    MODEL_NAME = f"swinunet_{args.exp}_manga109"
    ...
    # Data
    mean = [199.63495221, 199.63495221, 199.63495221]
    std = [90.40490831, 90.40490831, 90.40490831]
    ...
    if TRAIN_SIZE > 0:
        train_ds = SwinUNetDataset(
            "datasets/manga109/annotations/training/",
            "datasets/manga109/images/training/",
            transforms,
            target_transforms,
            SEED,
            TRAIN_SIZE,
    ...
    val_ds = SwinUNetDataset(
        "datasets/manga109/annotations/validation/",
        "datasets/manga109/images/validation/",
        transforms,
        target_transforms,
    )
    test_ds = SwinUNetDataset(
        "datasets/manga109/annotations/testing/",
        "datasets/manga109/images/testing/",
        transforms,
        target_transforms,
    )
