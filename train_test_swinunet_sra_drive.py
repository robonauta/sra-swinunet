...
def main():
    ...
    MODEL_NAME = f"swinunet_{args.exp}_drive"
    ...
    mean = [119.92289975, 61.920257, 36.57630925]
    std = [80.33846856, 39.47973503, 21.09764183]
    ...
    if TRAIN_SIZE > 0:
        train_ds = SwinUNetDataset(
            "datasets/drive/annotations/training/",
            "datasets/drive/images/training/",
            transforms,
            target_transforms,
            seed=13,
    ...
    val_ds = SwinUNetDataset(
        "datasets/drive/annotations/validation/",
        "datasets/drive/images/validation/",
        transforms,
        target_transforms,
        seed=13,
        train_size=DATASET_PERC,
    ...
    test_ds = SwinUNetDataset(
        "datasets/drive/annotations/testing/",
        "datasets/drive/images/testing/",
        transforms,
        target_transforms,
        seed=13,
        train_size=DATASET_PERC,
