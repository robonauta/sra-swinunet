...
from datasets import ADE20KSwinUNet
...
def main():
    ...
    MODEL_NAME = f"swinunet_{args.exp}_ade20k"
    ...
    if TRAIN_SIZE > 0:
        train_ds = ADE20KSwinUNet(
            "datasets/ade20k/annotations/training/",
            "datasets/ade20k/images/training/",
            transforms,
            target_transforms,
            seed=13,
    ...
    val_ds = ADE20KSwinUNet(
        "datasets/ade20k/annotations/validation/",
        "datasets/ade20k/images/validation/",
        transforms,
        target_transforms,
        seed=13,
        train_size=DATASET_PERC,
    )
    test_ds = ADE20KSwinUNet(
        "datasets/ade20k/annotations/testing/",
        "datasets/ade20k/images/testing/",
        transforms,
        target_transforms,
        seed=13,
        train_size=DATASET_PERC,
    ...
    loss_fn = GeneralizedDiceLoss(
        ...
        to_onehot_y=False,  # Enable one-hot encoding
        softmax=False,  # Enable softmax
    )
