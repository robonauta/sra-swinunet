...
from datasets import SwinUNetVolumetricH5Dataset
...
def main():
    ...
    MODEL_NAME = f"swinunet_{args.exp}_acdc"
    ...
    mean = [0.24615142442028468]
    std = [0.23737873063039436]
    ...
    if TRAIN_SIZE > 0:
        train_ds = SwinUNetVolumetricH5Dataset(
    ...
    val_ds = SwinUNetVolumetricH5Dataset(
        "datasets/acdc/validation/",
        transforms,
        target_transforms,
        seed=13,
        train_size=DATASET_PERC,
    )
    test_ds = SwinUNetVolumetricH5Dataset(
        "datasets/acdc/testing/",
        transforms,
        target_transforms,
        seed=13,
        train_size=DATASET_PERC,
